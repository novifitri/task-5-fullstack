            ...
            <div class="col-lg-4 mb-4"> 
                <div class="card shadow mb-4">
                    ...
                    <div class="card-header text-center">   
                            <a href="/articles/{{$article->id}}" class="btn btn-circle btn-info" title="Detail"><i class="fas fa-info mx-1" ></i></a>
                            <a href="/articles/{{$article->id}}/edit" class="btn btn-circle btn-warning" title="Edit"><i class="fas fa-pen mx-1"></i></a>
                            <button class="btn btn-danger btn-circle" data-toggle="modal" data-target="#deleteModal{{$article->id}}" title="Delete"><i class="fas fa-trash mx-1"></i></button>             
                    </div>
                </div> 
            </div>
